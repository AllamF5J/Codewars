...
| @description    : You were camping with your friends far away from home, but
|                   when it's time to go back, you realize that your fuel is
...
|
|                   Function should return true if it is possible and false if
|                   not.
|_______________________________________________________________________________
*/
bool zero_fuel(uint32_t distance_to_pump, uint32_t mpg, uint32_t fuel_left)
{
  return mpg >= distance_to_pump / fuel_left;
}