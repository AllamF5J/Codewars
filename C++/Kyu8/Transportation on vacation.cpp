...
| @description    : After a hard quarter in the office, you decide to get some
...
|                   Alternatively, if you rent the car for 3 or more days, you
...
{
  return d >= 7 ? (d * 40) - 50 : d >= 3 && d < 7 ? (d * 40) - 20
                                                  : (d * 40);
}