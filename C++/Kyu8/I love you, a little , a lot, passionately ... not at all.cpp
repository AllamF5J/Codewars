...
| @description    : Who remembers back to their time in the schoolyard, when
...
|                   number of petals. The number of petals is always greater
|                   than 0.
|_______________________________________________________________________________
*/
#include <string>
...
{
  std::string means[] = {"not at all", "I love you", "a little", "a lot", "passionately", "madly"};
